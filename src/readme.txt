...
Version 5.2
- Initial version to support Common Logging library.
- New SendEnumeration message type.
- Performance improvements.
- Bug fixes.

Documentation on CodePlex - Getting Started
https://insightextensions.codeplex.com/wikipage?title=Getting%20Started%20with%20Common.Logging%20Extension&referringTitle=Documentation
